...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--seg_output_nc', type=int, default=8, help='# of output image segmentation channels: 8 for lables')
        ...
        parser.add_argument('--crop_size_z', type=int, default=32, help='then crop to this size on z axis')
        ...
        parser.add_argument('--only_seg', action='store_true', default="False", help='load segmentor pre training')
