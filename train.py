...
if __name__ == '__main__':
    ...
    load_epoch = 0 if opt.epoch == "latest" else int(opt.epoch)
    for epoch in tqdm(range(load_epoch, opt.n_epochs + opt.n_epochs_decay)):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
