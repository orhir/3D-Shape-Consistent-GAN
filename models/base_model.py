...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        # self.load_dir = os.path.join(opt.checkpoints_dir, opt.load_name)  # save all the checkpoints to save_dir
        self.load_dir = os.path.join(opt.load_name)  # save all the checkpoints to save_dir
